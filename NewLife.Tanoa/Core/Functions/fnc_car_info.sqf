...
_control = ctrlSetStructuredText parseText format["Speed: %1<br />Armor: %2<br />Seats: %3<br />Fuel Capacity: %4<br />Weight Capacity: %5", _speed, _armor, _seats, _fuel, _array select 1];
